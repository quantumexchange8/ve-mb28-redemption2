...
const indicatorsRedeemed = ref();
const easRedeemed = ref();
const first = ref(0);
...
const loadLazyData = (event) => {
    ...
    setTimeout(async () => {
        try {
            ...
            indicatorsRedeemed.value = results?.indicatorsRedeemed;
            easRedeemed.value = results?.easRedeemed;
        } catch (error) {
...
watch([indicatorsRedeemed, easRedeemed], () => {
    emit('update-totals', {
        indicatorsRedeemed: indicatorsRedeemed.value,
        easRedeemed: easRedeemed.value,
    });
});
